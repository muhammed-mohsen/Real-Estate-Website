...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{route('users.index')}}">التحكم فى الرسائل</a></li>
       ...
       var lastIdx = null;
        ...
        $('#data thead th').each( function () {
            if($(this).index()  < 4 ){
                ...
                $(this).html( '<select><option value="1"> رسائل قديمة </option><option value="0"> رسائل جديدة</option></select>' );
            }
            else if($(this).index() == 5){
                    $(this).html( '<select>'+
'<option value="0"> اعجاب </option><option value="1"> مشكلة </option><option value="2"> مشكلة </option> value="3"> استفسار </option>'
  +
                '</select>' );
            }
